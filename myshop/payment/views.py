...
def payment_done(request):
    send_email(request, "Tu jest temat wiadomości", "emails/email_paymentDone.html")
...
def payment_canceled(request):
    send_email(
        request, "Tu jest temat wiadomości", "emails/email_paymentCancelled.html"
    )
...
def payment_process(request):
    ...
    return render(
        request, "payment/payment_process.html", {"order": order, "form": form}
    )
